    ...
    <div className=' overflow-hidden'>
      <div className='md:px-[20px] lg:px-[13%] md:flex gap-5 lg:flex py-5 mb-8'>
            ...
            <div className='max-sm:m-5'>
               <img className='md:w-auto md:h-auto lg:w-[350px] lg:h-[284px] cursor-pointer' src={headset} alt="headset-image" />
            </div>
            <div className='max-sm:m-5 lg:w-[350px] lg:h-[284px]'>
               <img className='md:w-auto md:h-auto lg:w-[350px] lg:h-[284px] cursor-pointer' src={speaker} alt="speaker-image" />
            </div>
            <div className='max-sm:m-5 lg:w-[350px] lg:h-[284px]'>
              <img className='md:w-auto md:h-auto lg:w-[350px] lg:h-[284px] cursor-pointer' src={headphone} alt="headphone-image" />
            </div>
      </div>
