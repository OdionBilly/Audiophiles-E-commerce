  ...
  return (
    <div className=" overflow-hidden">
      ...
      <div className="text-[#f1f1f1] text-center bg-[#D87D4A] py-10 lg:flex lg:h-[530px] lg:mx-[13%]">
        ...
        <div className="">
          <h2 className="sm:w-[280px] sm:h-[80px] leading-10 text-[36px] font-primarybold md:leading-[60px] md:w-[261px] md:h-[116px] md:py-4 md:ml-[259px] md:text-[56px] lg:ml-[200px] lg:mt-[100px] lg:text-left">
            ZX9 <br />
            SPEAKER
          </h2>
          <p className=" ml-[50px] w-[280px] h-[75px] text-[15px] py-5 md:w-[349px] md:ml-[220px] md:py-10 lg:text-left lg:ml-[200px]">
      ...
      <div className="bg-[#dedddd] lg:bg-[white] w-[375px] lg:w-[1110px] h-[320px] flex mt-[40px] mx-2 px-4 md:w-auto lg:mx-[13%] lg:mt-[80px]">
        ...
        <div className="">
          ...
          <img
            className="max-md:hidden lg:hidden md:ml-[100px] md:pl-10"
            src={bitmap1}
            alt="tablet-image"
          />
          <img
            className="max-lg:hidden lg:ml-[200px]"
            src={bitmap2}
            alt="desktop-image"
          />
        </div>
      ...
      <div className="lg:mt-[50px]">
        <div className="mt-[40px] md:flex gap-1 lg:px-[10%] lg:mt-[50px]">
          <div className="mx-2 w-[378px] lg:w-[540px]">
            <img
              className="w-[378px] md:h-[320px] lg:w-[540px]"
              src={HeadphoneB}
